...
from sesame_client.models.bad_request_response import BadRequestResponse  # noqa: E501
...
class TestBadRequestResponse(unittest.TestCase):
    ...
    def testBadRequestResponse(self):
        ...
        # model = sesame_client.models.bad_request_response.BadRequestResponse()  # noqa: E501
        pass
