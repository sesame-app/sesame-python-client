...
class InlineObject(object):
    ...
    @property
    def command(self):
        """Gets the command of this InlineObject.  # noqa: E501


        :return: The command of this InlineObject.  # noqa: E501
        :rtype: str
        """
    ...
    def command(self, command):
        """Sets the command of this InlineObject.


        :param command: The command of this InlineObject.  # noqa: E501
        :type: str
        """
        if command is None:
