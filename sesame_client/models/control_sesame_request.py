...
class ControlSesameRequest(object):
    ...
    def __init__(self, command=None):  # noqa: E501
        """ControlSesameRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def command(self):
        """Gets the command of this ControlSesameRequest.  # noqa: E501


        :return: The command of this ControlSesameRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def command(self, command):
        """Sets the command of this ControlSesameRequest.


        :param command: The command of this ControlSesameRequest.  # noqa: E501
        :type: str
        """
        if command is None:
            raise ValueError("Invalid value for `command`, must not be `None`")  # noqa: E501
        allowed_values = ["lock", "unlock", "sync"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ControlSesameRequest):
            return False
